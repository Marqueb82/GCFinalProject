...
@Component
public class TicketMasterAPIService11 {
  ...
  @Autowired
  public TicketMasterAPIService11(@Value("${apiKey}") String apiKey) {
    this(apiKey, DiscoveryApiConfiguration.builder().build());
  }

  public TicketMasterAPIService11(String apiKey, DiscoveryApiConfiguration configuration) {
